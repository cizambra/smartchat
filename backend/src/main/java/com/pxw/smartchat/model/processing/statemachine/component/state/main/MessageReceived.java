...
import com.pxw.smartchat.config.system.TextParser;
...
public class MessageReceived implements State {
    ...
    public StateMessage run(final String message) throws Exception {
        final ArrayList<String> sentences = TextParser.getSentences(message);
        final ArrayList<String> questions = TextParser.extractQuestions(sentences);
